/****************************************************************************
** Meta object code from reading C++ file 'medicinemodel.h'
**
...
#error "The header file 'medicinemodel.h' doesn't include <QObject>."
...
static constexpr auto qt_meta_stringdata_CLASSMedicineModelENDCLASS = QtMocHelpers::stringData(
    "MedicineModel"
);
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASSMedicineModelENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASSMedicineModelENDCLASS_t qt_meta_stringdata_CLASSMedicineModelENDCLASS = {
    {
        QT_MOC_LITERAL(0, 13)   // "MedicineModel"
    },
    "MedicineModel"
};
