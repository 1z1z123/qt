...
Q_CONSTINIT static const qt_meta_stringdata_CLASSNetworkManagerENDCLASS_t qt_meta_stringdata_CLASSNetworkManagerENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(15, 13),  // "syncCompleted"
        QT_MOC_LITERAL(29, 0),  // ""
        QT_MOC_LITERAL(30, 7),  // "success"
        QT_MOC_LITERAL(38, 15),  // "backupCompleted"
        QT_MOC_LITERAL(54, 14),  // "onSyncFinished"
        QT_MOC_LITERAL(69, 14),  // "QNetworkReply*"
        QT_MOC_LITERAL(84, 5),  // "reply"
        QT_MOC_LITERAL(90, 16)   // "onBackupFinished"
    },
    "NetworkManager",
    "syncCompleted",
    "",
...
void NetworkManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->syncCompleted((*reinterpret_cast< std::add_pointer_t<bool>>(_a[1]))); break;
        case 1: _t->backupCompleted((*reinterpret_cast< std::add_pointer_t<bool>>(_a[1]))); break;
        case 2: _t->onSyncFinished((*reinterpret_cast< std::add_pointer_t<QNetworkReply*>>(_a[1]))); break;
        case 3: _t->onBackupFinished((*reinterpret_cast< std::add_pointer_t<QNetworkReply*>>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &NetworkManager::syncCompleted; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (NetworkManager::*)(bool );
            if (_t _q_method = &NetworkManager::backupCompleted; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void NetworkManager::syncCompleted(bool _t1)
{
...
// SIGNAL 1
void NetworkManager::backupCompleted(bool _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
