...
static constexpr auto qt_meta_stringdata_CLASSInventoryModelENDCLASS = QtMocHelpers::stringData(
    "InventoryModel"
);
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASSInventoryModelENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASSInventoryModelENDCLASS_t qt_meta_stringdata_CLASSInventoryModelENDCLASS = {
    {
        QT_MOC_LITERAL(0, 14)   // "InventoryModel"
    },
    "InventoryModel"
};
