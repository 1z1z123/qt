...
static constexpr auto qt_meta_stringdata_CLASSDoctorDialogENDCLASS = QtMocHelpers::stringData(
    "DoctorDialog",
    "accept",
    "",
    "loadDoctorData",
...
Q_CONSTINIT static const qt_meta_stringdata_CLASSDoctorDialogENDCLASS_t qt_meta_stringdata_CLASSDoctorDialogENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(20, 0),  // ""
        QT_MOC_LITERAL(21, 14),  // "loadDoctorData"
        QT_MOC_LITERAL(36, 8)   // "doctorId"
    },
    "DoctorDialog",
    "accept",
    "",
...
void DoctorDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<DoctorDialog *>(_o);
        (void)_t;
        switch (_id) {
        case 0: _t->accept(); break;
        case 1: _t->loadDoctorData((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
        default: ;
        }
    }
}
