/****************************************************************************
** Meta object code from reading C++ file 'doctormodel.h'
**
...
#error "The header file 'doctormodel.h' doesn't include <QObject>."
...
static constexpr auto qt_meta_stringdata_CLASSDoctorModelENDCLASS = QtMocHelpers::stringData(
    "DoctorModel"
);
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASSDoctorModelENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASSDoctorModelENDCLASS_t qt_meta_stringdata_CLASSDoctorModelENDCLASS = {
    {
        QT_MOC_LITERAL(0, 11)   // "DoctorModel"
    },
    "DoctorModel"
};
